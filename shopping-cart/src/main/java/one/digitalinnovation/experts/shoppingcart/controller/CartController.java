...
import one.digitalinnovation.experts.shoppingcart.model.Iten;
...
public class CartController {
    ...
    public Cart addIten(@PathVariable("id") Integer id, @RequestBody Iten iten){
    ...
    public void clearCart(@PathVariable("id") Integer id) {cartRepository.deleteById(id);}
